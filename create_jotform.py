...
def add_questions(form_id):
    # Question 1: Variant Selection (Dropdown)
    variant_question = {
        "question[type]": "control_dropdown",
        "question[text]": "Select Your Exam Variant",
        "question[order]": "1",
        "question[name]": "variant",
        "question[required]": "Yes",
        "question[options]": "Variant 1|Variant 2|Variant 3|Variant 4|Variant 5"
    }
    
    response = requests.post(f"{BASE_URL}/form/{form_id}/questions", 
                            data=variant_question, headers=headers)
    if response.status_code == 200:
        variant_qid = response.json()["content"]["qid"]
        print(f"Added variant selection dropdown: {variant_qid}")
    else:
        print(f"Error adding variant question: {response.text}")
        return
    ...
    v1_questions = [
        ...
        {
            "type": "control_radio",
            "text": "V1-Q1: Which definition best describes an algorithm?",
            "order": "2",
            "name": "v1q1",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q2: What are the primary commands available to the Kangaroo performer?",
            "order": "3",
            "name": "v1q2",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q3: What distinguishes manual control mode from automatic control mode?",
            "order": "4",
            "name": "v1q3",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q4: What constitutes a computer program?",
            "order": "5",
            "name": "v1q4",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q5: What is the primary purpose of syntax diagrams?",
            "order": "6",
            "name": "v1q5",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q6: What process does compilation represent?",
            "order": "7",
            "name": "v1q6",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q7: Which languages are classified as high-level programming languages?",
            "order": "8",
            "name": "v1q7",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q8: What defines an identifier in programming?",
            "order": "9",
            "name": "v1q8",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q9: Which operator handles standard output in C++?",
            "order": "10",
            "name": "v1q9",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V1-Q10: What semantic meaning does the ::= symbol carry in BNF notation?",
            "order": "11",
            "name": "v1q10",
            "required": "Yes",
        ...
        # Q11 - Text Area
        {
            ...
            "text": "V1-Q11: Implement a C++ program that outputs \"Hello, world!\" to the console",
            "order": "12",
            "name": "v1q11",
            "required": "Yes"
        },
        # Q12 - Checkbox (multiple selection)
        {
            "type": "control_checkbox",
            "text": "V1-Q12: Identify valid C++ identifiers from the following:",
            "order": "13",
            "name": "v1q12",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V1-Q13: Construct a BNF production rule for decimal digits (0-9)",
            "order": "14",
            "name": "v1q13",
            "required": "Yes"
        }
    ...
    v2_questions = [
        {
            "type": "control_radio",
            "text": "V2-Q1: In computer science, what characterizes a performer?",
            "order": "15",
            "name": "v2q1",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q2: What command repertoire does the Ant performer possess?",
            "order": "16",
            "name": "v2q2",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q3: What fundamental process does compilation involve?",
            "order": "17",
            "name": "v2q3",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q4: What principal advantage do high-level languages provide?",
            "order": "18",
            "name": "v2q4",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q5: How are terminal symbols depicted in syntax diagrams?",
            "order": "19",
            "name": "v2q5",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q6: What does algorithmization encompass?",
            "order": "20",
            "name": "v2q6",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q7: What constitutes a performer's command system?",
            "order": "21",
            "name": "v2q7",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q8: Which operator manages standard input in C++?",
            "order": "22",
            "name": "v2q8",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q9: What defines terminal symbols in BNF grammar?",
            "order": "23",
            "name": "v2q9",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V2-Q10: What information does each syntax diagram path convey?",
            "order": "24",
            "name": "v2q10",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V2-Q11: Develop a C++ program displaying your personal name",
            "order": "25",
            "name": "v2q11",
            "required": "Yes"
        },
        {
            "type": "control_checkbox",
            "text": "V2-Q12: Recognize special operator symbols in C++:",
            "order": "26",
            "name": "v2q12",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V2-Q13: Formulate a BNF rule for Latin alphabet characters",
            "order": "27",
            "name": "v2q13",
            "required": "Yes"
        }
    ...
    v3_questions = [
        {
            "type": "control_radio",
            "text": "V3-Q1: What conceptual process does algorithmization represent?",
            "order": "28",
            "name": "v3q1",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q2: What comprises a performer's command repertoire?",
            "order": "29",
            "name": "v3q2",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q3: Which languages demonstrate high-level programming characteristics?",
            "order": "30",
            "name": "v3q3",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q4: What essential activity defines programming?",
            "order": "31",
            "name": "v3q4",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q5: How are non-terminal symbols represented syntactically?",
            "order": "32",
            "name": "v3q5",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q6: What characterizes machine language?",
            "order": "33",
            "name": "v3q6",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q7: What sequential stages comprise computer problem-solving?",
            "order": "34",
            "name": "v3q7",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q8: What functional purpose does BNF metalanguage serve?",
            "order": "35",
            "name": "v3q8",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q9: What distinguishes terminal symbols in formal grammar?",
            "order": "36",
            "name": "v3q9",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V3-Q10: What representational method applies to BNF syntax diagrams?",
            "order": "37",
            "name": "v3q10",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V3-Q11: Create a C++ program outputting numerical sequence 1-3",
            "order": "38",
            "name": "v3q11",
            "required": "Yes"
        },
        {
            "type": "control_checkbox",
            "text": "V3-Q12: Determine letter-initial sequences:",
            "order": "39",
            "name": "v3q12",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V3-Q13: Define BNF production for signed integer notation",
            "order": "40",
            "name": "v3q13",
            "required": "Yes"
        }
    ...
    v4_questions = [
        {
            "type": "control_radio",
            "text": "V4-Q1: What fundamental nature defines machine language?",
            "order": "41",
            "name": "v4q1",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q2: What systematic approach solves computational problems?",
            "order": "42",
            "name": "v4q2",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q3: What analytical function does BNF metalanguage perform?",
            "order": "43",
            "name": "v4q3",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q4: What constitutes terminal symbols in formal definition?",
            "order": "44",
            "name": "v4q4",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q5: What visualization technique represents BNF formally?",
            "order": "45",
            "name": "v4q5",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q6: What integrated functionality defines development environments?",
            "order": "46",
            "name": "v4q6",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q7: What operational capabilities do IDEs provide?",
            "order": "47",
            "name": "v4q7",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q8: What descriptive purpose do syntax diagrams serve?",
            "order": "48",
            "name": "v4q8",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q9: What abstract role do non-terminal symbols fulfill?",
            "order": "49",
            "name": "v4q9",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V4-Q10: What linguistic information does syntax diagram traversal provide?",
            "order": "50",
            "name": "v4q10",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V4-Q11: Implement a C++ program displaying academic subject preference",
            "order": "51",
            "name": "v4q11",
            "required": "Yes"
        },
        {
            "type": "control_checkbox",
            "text": "V4-Q12: Identify C++ reserved keywords:",
            "order": "52",
            "name": "v4q12",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V4-Q13: Specify BNF grammar for identifier construction",
            "order": "53",
            "name": "v4q13",
            "required": "Yes"
        }
    ...
    v5_questions = [
        {
            "type": "control_radio",
            "text": "V5-Q1: What comprehensive toolset defines development environments?",
            "order": "54",
            "name": "v5q1",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q2: What functional integration characterizes modern IDEs?",
            "order": "55",
            "name": "v5q2",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q3: What representational method describes syntax diagrams?",
            "order": "56",
            "name": "v5q3",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q4: What grammatical function do non-terminal symbols perform?",
            "order": "57",
            "name": "v5q4",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q5: What linguistic validity does syntax path analysis establish?",
            "order": "58",
            "name": "v5q5",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q6: What conceptual framework defines algorithms?",
            "order": "59",
            "name": "v5q6",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q7: What operational commands characterize the Kangaroo performer?",
            "order": "60",
            "name": "v5q7",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q8: What operational distinction separates control modes?",
            "order": "61",
            "name": "v5q8",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q9: What executable entity constitutes a program?",
            "order": "62",
            "name": "v5q9",
            "required": "Yes",
        ...
        {
            "type": "control_radio",
            "text": "V5-Q10: What descriptive utility do syntax diagrams provide?",
            "order": "63",
            "name": "v5q10",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V5-Q11: Develop a C++ program outputting current date information",
            "order": "64",
            "name": "v5q11",
            "required": "Yes"
        },
        {
            "type": "control_checkbox",
            "text": "V5-Q12: Recognize compound operator symbols:",
            "order": "65",
            "name": "v5q12",
            "required": "Yes",
        ...
        {
            "type": "control_textarea",
            "text": "V5-Q13: Define BNF production for arithmetic signs",
            "order": "66",
            "name": "v5q13",
            "required": "Yes"
        }
...
def add_conditions(form_id, variant_qid):
    print("\nNote: JotForm API has limitations for programmatically adding complex conditional logic.")
    print("You'll need to manually configure Show/Hide conditions in the JotForm Builder.")
    print("\nInstructions for manual configuration:")
    print("1. Open the form in JotForm Builder")
    print("2. For each variant's questions (v1q1-v1q13, v2q1-v2q13, etc.):")
    print("   - Click on the question")
    print("   - Go to 'Conditions' tab")
    print("   - Add condition: Show this field if 'variant' equals 'Variant X'")
    print("3. Save the form")

# Main execution
if __name__ == "__main__":
    print("Creating JotForm for Programming Fundamentals Examination...")
    ...
    if form_id:
        # Add questions
        variant_qid = add_questions(form_id)
        
        # Instructions for conditional logic
        add_conditions(form_id, variant_qid)
        
        print(f"\n✓ Form created successfully!")
        print(f"Form ID: {form_id}")
        print(f"Form URL: https://form.jotform.com/{form_id}")
        print(f"\nNext steps:")
        print(f"1. Open the form URL above")
        print(f"2. Configure conditional logic as described")
        print(f"3. Customize form appearance if needed")
        print(f"4. Test the form with all 5 variants")
